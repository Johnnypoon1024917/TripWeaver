...
export default function ProfileScreen() {
    ...
    useEffect(() => {
        ...
        Animated.stagger(100, statsAnims.map(anim => Animated.spring(anim, {
            toValue: 1,
            useNativeDriver: true,
            tension: 50,
            friction: 7,
    ...
    return (<ScrollView style={styles.container>
      ...
      <View style={styles.section>
        {/* Language Selector */
        <TouchableOpacity style={styles.menuItem onPress={() => setShowLanguages(!showLanguages)>
        ...
        {showLanguages && (<View style={styles.languageList>
            {languages.map((lang) => (<TouchableOpacity key={lang.code style={[
                    styles.languageItem,
      ...
      <TouchableOpacity onPress={handleLogout>
        <LinearGradient colors={[colors.error, '#C0392B'] style={styles.logoutButton start={{ x: 0, y: 0  end={{ x: 1, y: 0 >
