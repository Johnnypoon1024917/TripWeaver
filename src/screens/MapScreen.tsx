  ...
  return (
    <View style={styles.container}>
      <MapView
        ...
        region={region}
        customMapStyle={Platform.OS !== 'web' ? mapStyle : undefined}
        ...
        {Platform.OS !== 'web' && (
          <>
            ...
            {currentDayDestinations.length > 1 && (
              <Polyline
                coordinates={currentDayDestinations.map(dest => ({
                  latitude: dest.latitude,
                  longitude: dest.longitude,
                }))}
      ...
      <View style={styles.legend}>
        {currentDayDestinations.slice(0, 3).map((dest, index) => (
          <View key={dest.id} style={styles.legendItem}>
        ...
        {currentDayDestinations.length > 3 && (
          <Text style={styles.legendMore}>+{currentDayDestinations.length - 3} more</Text>
        )}
      </View>
    </View>
  );
