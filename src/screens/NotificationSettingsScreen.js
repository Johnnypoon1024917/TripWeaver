    ...
    return (<SafeAreaView style={styles.container>
      <ScrollView style={styles.scrollView>
        ...
        <View style={styles.settingItem>
         ...
         trackColor={{ false: '#767577', true: '#81b0ff'  thumbColor={notificationsEnabled ? '#007AFF' : '#f4f3f4'/>
        </View>
        ...
        <View style={styles.settingItem>
          ...
          <Switch value={tripReminders onValueChange={(value) => {
            setTripReminders(value);
            toggleSetting('tripRemindersEnabled', value);
         disabled={!notificationsEnabled trackColor={{ false: '#767577', true: '#81b0ff'  thumbColor={tripReminders ? '#007AFF' : '#f4f3f4'/>
        </View>
        ...
        <View style={styles.settingItem>
          ...
          <Switch value={budgetAlerts onValueChange={(value) => {
            setBudgetAlerts(value);
            toggleSetting('budgetAlertsEnabled', value);
         disabled={!notificationsEnabled trackColor={{ false: '#767577', true: '#81b0ff'  thumbColor={budgetAlerts ? '#007AFF' : '#f4f3f4'/>
        </View>
        ...
        <View style={styles.settingItem>
          ...
          <Switch value={collaborationNotifications onValueChange={(value) => {
            setCollaborationNotifications(value);
            toggleSetting('collaborationNotificationsEnabled', value);
         disabled={!notificationsEnabled trackColor={{ false: '#767577', true: '#81b0ff'  thumbColor={collaborationNotifications ? '#007AFF' : '#f4f3f4'/>
        </View>
        ...
        <View style={styles.settingItem>
          ...
          <Switch value={weatherAlerts onValueChange={(value) => {
            setWeatherAlerts(value);
            toggleSetting('weatherAlertsEnabled', value);
         disabled={!notificationsEnabled trackColor={{ false: '#767577', true: '#81b0ff'  thumbColor={weatherAlerts ? '#007AFF' : '#f4f3f4'/>
        </View>
        ...
        <View style={styles.settingItem>
          ...
          <Switch value={settings.quietHoursEnabled ?? false onValueChange={(value) => {
            toggleSetting('quietHoursEnabled', value);
         disabled={!notificationsEnabled trackColor={{ false: '#767577', true: '#81b0ff'  thumbColor={(settings.quietHoursEnabled ?? false) ? '#007AFF' : '#f4f3f4'/>
        </View>
