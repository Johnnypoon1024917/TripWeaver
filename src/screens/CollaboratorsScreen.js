...
export default function CollaboratorsScreen({ route, navigation }) {
    ...
    const trip = useSelector((state) => state.trips.items.find((t) => t.id === tripId));
    ...
    return (<View style={styles.container}>
      ...
      <View style={styles.inviteSection}>
        ...
        <TextInput style={styles.input} placeholder="Enter email address" placeholderTextColor={colors.textLight} value={email} onChangeText={setEmail} keyboardType="email-address" autoCapitalize="none"/>
        ...
        <TouchableOpacity onPress={handleInvite}>
          <LinearGradient colors={[colors.primary, colors.gradientEnd]} style={styles.inviteButton} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }}>
      ...
      <View style={styles.listSection}>
        ...
        <FlatList data={collaborators} keyExtractor={(item) => item.userId} renderItem={({ item }) => (<View style={styles.collaboratorItem}>
              <View style={styles.collaboratorLeft}>
                ...
                <View style={styles.collaboratorInfo}>
                  ...
                  {item.displayName && (<Text style={styles.collaboratorEmail}>{item.email}</Text>)}
                ...
                { color: getRoleColor(item.role) },
                    ...
                    {item.status === 'pending' && (<Text style={styles.pendingBadge}>• Pending</Text>)}
                  </View>
                </View>
              </View>

              {item.role !== 'owner' && (<TouchableOpacity onPress={() => handleRemoveCollaborator(item.userId)} style={styles.removeButton}>
