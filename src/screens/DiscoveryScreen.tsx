  ...
  const renderTripItem = ({ item : { item: PublicTrip ) => {
    ...
    return (
      <TouchableOpacity 
        ...
        onPress={() => console.log('View trip details', item.id)
      >
        {item.coverImage ? (
          <Image 
        ...
        <View style={styles.tripContent>
          ...
          <View style={styles.tripActions>
            <TouchableOpacity 
              ...
              onPress={() => handleLikeTrip(item.id)
            >
  ...
  return (
    <View style={styles.container>
      ...
      <View style={styles.filterContainer>
        {['popular', 'recent', 'duration'].map((filter) => (
          <TouchableOpacity
            key={filter
            style={[
              styles.filterButton,
