...
export class CalendarService {
   ...
   */
  static async createTripEvents(trip: any, itinerary: any[]): Promise<boolean> {
    try {
   ...
   */
  static async syncWithGoogleCalendar(trip: any, itinerary: any[]): Promise<boolean> {
    try {
   ...
   */
  static async exportAsICalendar(trip: any, itinerary: any[]): Promise<boolean> {
    try {
