...
function TabNavigator() {
    return (<Tab.Navigator screenOptions={{
      ...
      <Tab.Screen name="Journal" component={TravelJournalScreen} options={{
            tabBarLabel: 'Journal',
            tabBarIcon: ({ color }) => <RNText style={{ fontSize: 20 }}>📝</RNText>,
        }}/>
      <Tab.Screen name="Map" component={MapboxMapScreen} options={{
            tabBarLabel: 'Map',
            tabBarIcon: ({ color }) => <RNText style={{ fontSize: 20 }}>🗺️</RNText>,
        }}/>
      <Tab.Screen name="Budget" component={EnhancedBudgetScreen} options={{
            tabBarLabel: 'Budget',
            tabBarIcon: ({ color }) => <RNText style={{ fontSize: 20 }}>💰</RNText>,
        }}/>
    ...
    return (<NavigationContainer>
      <Stack.Navigator screenOptions={{ headerShown: false }}>
        {!isAuthenticated ? (<>
            ...
            <Stack.Screen name="TripDetail" component={TripDetailScreen} options={{ headerShown: true, title: 'Trip Details' }}/>
            <Stack.Screen name="CreateTrip" component={CreateTripScreen} options={{ headerShown: true, title: 'Create Trip' }}/>
            <Stack.Screen name="AddDestination" component={AddDestinationScreen} options={{ headerShown: true, title: 'Add Destination' }}/>
            <Stack.Screen name="Collaborators" component={CollaboratorsScreen} options={{ headerShown: true, title: 'Manage Collaborators' }}/>
            <Stack.Screen name="Explore" component={ExploreScreen} options={{ headerShown: true, title: 'Explore Places' }}/>
            ...
            <Stack.Screen name="NotificationTest" component={NotificationTestScreen} options={{ headerShown: true, title: 'Notification Test' }}/>
          </>)}
      </Stack.Navigator>
    </NavigationContainer>);
}
