...
const AddDestinationModal = ({ visible, onClose, onAddDestination, }) => {
      ...
      <View style={styles.container}>
        ...
        <ScrollView style={styles.content}>
          <View style={styles.inputGroup}>
            ...
            <TextInput style={styles.input} value={name} onChangeText={setName} placeholder="Enter destination name" autoFocus/>
          </View>
          ...
          <View style={styles.inputGroup}>
            ...
            <TextInput style={[styles.input, styles.textArea]} value={notes} onChangeText={setNotes} placeholder="Add any notes" multiline numberOfLines={3}/>
          </View>
